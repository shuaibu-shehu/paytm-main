  ...
  return (
    <div className=' rounded-xl bg-slate-200 p-4 max-w-[400px] mx-auto m-4 flex flex-col gap-4'>
      <div className=' text-center flex flex-col gap-3'>
          ...
          <p className='text-slate-600'>Enter your information to <br /> Login to your account</p>
      </div>
      <form onSubmit={handleOnSubmit} className='flex flex-col  gap-4' >
          ...
          <div>
              <button className=' bg-slate-950 text-white rounded-lg w-full p-2 font-bold tex' type="submit">Sign In</button>
          </div>
          <div>
              <label />
              <div className='text-slate-500'>
                  Register an account?{' '}
                  <Link className="text-slate-950" to="/signup">Sign Up</Link>
              </div>
          </div>
      </form>
      </div>
